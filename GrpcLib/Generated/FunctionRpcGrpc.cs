...
namespace Test.Grpc.Messages {
  ...
  {
    static readonly string __ServiceName = "FunctionRpc.FunctionRpc";

    static readonly grpc::Marshaller<global::Test.Grpc.Messages.StreamingMessage> __Marshaller_StreamingMessage = grpc::Marshallers.Create((arg) => global::Google.Protobuf.MessageExtensions.ToByteArray(arg), global::Test.Grpc.Messages.StreamingMessage.Parser.ParseFrom);

    static readonly grpc::Method<global::Test.Grpc.Messages.StreamingMessage, global::Test.Grpc.Messages.StreamingMessage> __Method_EventStream = new grpc::Method<global::Test.Grpc.Messages.StreamingMessage, global::Test.Grpc.Messages.StreamingMessage>(
    ...
    {
      get { return global::Test.Grpc.Messages.FunctionRpcReflection.Descriptor.Services[0]; }
    }
    ...
    public partial class FunctionRpcClient : grpc::ClientBase<FunctionRpcClient>
    {
      ...
      public virtual grpc::AsyncDuplexStreamingCall<global::Test.Grpc.Messages.StreamingMessage, global::Test.Grpc.Messages.StreamingMessage> EventStream(grpc::Metadata headers = null, DateTime? deadline = null, CancellationToken cancellationToken = default(CancellationToken))
      {
        return EventStream(new grpc::CallOptions(headers, deadline, cancellationToken));
      }
      public virtual grpc::AsyncDuplexStreamingCall<global::Test.Grpc.Messages.StreamingMessage, global::Test.Grpc.Messages.StreamingMessage> EventStream(grpc::CallOptions options)
      {
